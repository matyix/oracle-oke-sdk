...
type CreateParams struct {
	...
	*/
	Body *models.ClustersapiCreateRequest
	/*OwnerID
...
func (o *CreateParams) WithBody(body *models.ClustersapiCreateRequest) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.ClustersapiCreateRequest) {
	o.Body = body
}

// WithOwnerID adds the ownerID to the create params
func (o *CreateParams) WithOwnerID(ownerID string) *CreateParams {
	o.SetOwnerID(ownerID)
	return o
}

// SetOwnerID adds the ownerId to the create params
func (o *CreateParams) SetOwnerID(ownerID string) {
	o.OwnerID = ownerID
}
