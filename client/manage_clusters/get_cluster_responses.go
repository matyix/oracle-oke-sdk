...
Details of cluster specified by clusterId.
*/
type GetClusterOK struct {
	Payload *models.ClustersapiClusterDetails
}

func (o *GetClusterOK) Error() string {
	return fmt.Sprintf("[GET /api/v3/clusters/{ownerId}/{clusterId}][%d] getClusterOK  %+v", 200, o.Payload)
}

func (o *GetClusterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ClustersapiClusterDetails)
