...
// WithOwnerID adds the ownerID to the delete cluster params
func (o *DeleteClusterParams) WithOwnerID(ownerID string) *DeleteClusterParams {
	o.SetOwnerID(ownerID)
	return o
}

// SetOwnerID adds the ownerId to the delete cluster params
func (o *DeleteClusterParams) SetOwnerID(ownerID string) {
	o.OwnerID = ownerID
}
